...
Inicialmente iremos utilizar o GGally para observar a correlação entre as disciplinas e o cra.
...
Podemos verificar que os erros são de fato aleatórios ao observar os gráficos de resíduo.
